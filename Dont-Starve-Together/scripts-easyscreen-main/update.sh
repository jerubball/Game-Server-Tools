...
steamcmd +@ShutdownOnFailedCommand 1 +@NoPromptForPassword 1 +login anonymous +app_info_update 1 +app_info_print 343050 +quit | grep "AppID : 343050," > ~/.klei/Dont-Starve-Together-Dedicated-Server-main/changenumber
...
steamcmd +@ShutdownOnFailedCommand 1 +@NoPromptForPassword 1 +login anonymous +force_install_dir ~/.klei/Dont-Starve-Together-Dedicated-Server-main +app_update 343050 validate +quit
...
cd ~/.klei/Dont-Starve-Together-Dedicated-Server-main/mods
