...
version=$(cat ~/.klei/Dont-Starve-Together-Dedicated-Server-main/version.txt || echo "")
current=$(cat ~/.klei/Dont-Starve-Together-Dedicated-Server-main/changenumber || echo "")
