...
execute at @e[type=armor_stand,distance=0..20] run data merge entity @e[limit=1,distance=0] {Invulnerable:1b,NoGravity:1b,ShowArms:1b,CustomNameVisible:1b,Rotation:[180.0f,90.0f],Pose:{Head:[0.0f, 0.0f, 0.0f],Body:[0.0f, 0.0f, 0.0f]}}
