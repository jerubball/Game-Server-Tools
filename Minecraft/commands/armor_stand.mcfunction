...
summon armor_stand ~ ~1 ~ {Invulnerable:1b,NoGravity:1b,Small:1b,Tags:["pointer"],DisabledSlots:16191,Pose:{Head:[180.0f, 45.0f, 0.0f]}}
effect give @e[type=armor_stand,tag=pointer,sort=nearest,limit=1] glowing 10000 0 true
execute at jerubball positioned ^ ^ ^2 run tp @e[type=armor_stand,tag=pointer,sort=nearest,limit=1] ~ ~1.6 ~
