...
summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,ShowArms:0b,NoBasePlate:1b,DisabledSlots:16191,CustomNameVisible:1b,CustomName:"{\"text\":\"jerubball\",\"underlined\":true}"}
