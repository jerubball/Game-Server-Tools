...
execute if entity @a[scores={DeathTrigger=1..}] run tellraw @a[scores={DeathTrigger=1..}] [{"text":"You died at: (x ","color":"green"},{"score":{"name":"*","objective":"DeathPosX"},"color":"white"},{"text":", y "},{"score":{"name":"*","objective":"DeathPosY"},"color":"white"},{"text":", z "},{"score":{"name":"*","objective":"DeathPosZ"},"color":"white"},{"text":")"}]
execute if entity @a[scores={DeathTrigger=1..}] run scoreboard players reset @a[scores={DeathTrigger=1..}] DeathTrigger
