...
execute if entity @a[scores={jerubball=-57}] run tellraw @a[scores={jerubball=-57}] [{"text":"Teleport request sent to ","color":"gray"},{"selector":"jerubball"}]
...
execute if entity @a[scores={jerubball=-1}] run tellraw @a[scores={jerubball=-1}] [{"text":"Teleport request to ","color":"gray"},{"selector":"jerubball"},{"text":" expired","color":"gray"}]
